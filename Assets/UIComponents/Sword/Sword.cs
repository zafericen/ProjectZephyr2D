...
namespace ProjectZephyr
{
    public class Sword : WeaponBase
    {
        ...
        {
            new LavaSword_CA(attackPerformer,GetOverrideFromList(Attacks.Combo,0),new List<AttackInputType>{AttackInputType.Normal,AttackInputType.Special,AttackInputType.WeaponArt}, AttackInputType.Normal),
        };
        }
